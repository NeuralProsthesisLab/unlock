...
# win-x86 libs find acquire-c++/boost/win-x86/lib | grep -v -e lib$  -e gd | sed s/^/\'/ | sed s/$/\',/
                'unlock.neural' : ['acquire/boost_chrono-vc110-mt-1_54.dll', 'acquire/boost_date_time-vc110-mt-1_54.dll',
                            'acquire/boost_python-vc110-mt-1_54.dll', 'acquire/boost_system-vc110-mt-1_54.dll',
                            'acquire/boost_thread-vc110-mt-1_54.dll', 'acquire/boost_unit_test_framework-vc110-mt-1_54.dll',
                            'acquire/Enobio3GAPI.dll', 'acquire/QtCore4.dll', 'acquire/WinBluetoothAPI.dll',
                            'acquire/msvcr110.dll', 'acquire/msvcp110.dll',
